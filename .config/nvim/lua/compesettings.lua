...
require'compe'.setup {
  ...
  --documentation = true;
  documentation = {
    border = { 'AAAAAAAAAAAAA', '' ,'', ' ', '', '', '', ' ' }, -- the border option is the same as `|help nvim_open_win|`
...
vim.api.nvim_set_keymap("i", "<CR>", "compe#confirm(lexima#expand('<LT>CR>', 'i'))", {expr = true, silent=true})
